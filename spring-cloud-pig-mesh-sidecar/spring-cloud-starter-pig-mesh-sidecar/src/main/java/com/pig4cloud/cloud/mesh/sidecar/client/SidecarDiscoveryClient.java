...
public interface SidecarDiscoveryClient {
	...
	/**
	 * register instance.
	 * @param properties 注册信息
	 */
	void registerInstance(MeshSidecarProperties properties);

	/**
	 * deregister instance.
	 * @param properties 注销信息
	 */
	void deregisterInstance(MeshSidecarProperties properties);
