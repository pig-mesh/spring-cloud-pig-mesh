...
import com.pig4cloud.cloud.mesh.config.client.client.endpoint.InstanceEndpoint;
import com.pig4cloud.cloud.mesh.config.client.client.endpoint.ServiceEndpoint;
import com.pig4cloud.cloud.mesh.config.client.client.store.InMemoryServiceStore;
